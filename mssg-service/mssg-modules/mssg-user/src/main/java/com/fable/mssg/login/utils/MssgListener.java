package com.fable.mssg.login.utils;
...
import com.fable.mssg.user.service.impl.SysUserServiceImpl;
 ...
 */
@WebListener
public class MssgListener implements HttpSessionListener {
    ...
    public void sessionDestroyed(HttpSessionEvent httpSessionEvent) {
        ...
        if(loginUserInfo!=null){
            ...
            LoginServiceImpl.sessionMap.remove(loginUserInfo.getSysUser().getId());
        }
    }
